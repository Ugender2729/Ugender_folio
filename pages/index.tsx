    ...
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <motion.h1
              data-text="I'm Ugender Dharavath"
              className="intro__text"
              {...getTransitions(0.1)}
            >
              <mark className="mark">I&apos;m Ugender Dharavath</mark>
            </motion.h1>
            <motion.p {...getTransitions(0.3)}>
              {' '}
              Your friendly neighborhood frontend developer with 4+ years of experience in React.js, JavaScript, and modern web technologies. I specialize in building responsive, interactive web applications and have a strong track record of delivering high-quality solutions for enterprise clients like Citi Bank, Quantela, and TUMI.{' '}
              <Link href="/projects" aria-label="Go to Projects Page">
                Projects
              </Link>{' '}
              showcase my expertise in React.js, Redux, D3.js, and cross-platform development. I'm passionate about creating seamless user experiences and turning complex requirements into elegant, scalable solutions.{' '}
            </motion.p>
            <motion.p {...getTransitions(0.5)}>
              With expertise in React Hooks, Context API, and modern JavaScript, I've successfully delivered projects ranging from enterprise dashboards to e-commerce platforms. My experience includes real-time applications with Socket.IO, mobile development with React Native, and integration with various APIs and services. I'm always eager to{' '}
              <Link
                href="/articles"
              ...
              and take on challenging projects that push the boundaries of what's possible on the web. Feel free to{' '}
